...
class AgentHomeActivity : AppCompatActivity() {
    ...
    private val waveformObserver: (Float) -> Unit = { level -> runOnUiThread { binding.waveform.pushLevel(level) } }
    ...
    override fun onResume() {
        ...
        AudioLevelState.observe(waveformObserver)
    }

    override fun onPause() {
        super.onPause()
        AgentState.removeObserver(stateObserver)
        AudioLevelState.removeObserver(waveformObserver)
    }
